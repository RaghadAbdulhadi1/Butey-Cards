...
export default class RegisterForm extends Form {
  ...
  onSubmit() {
    this.email = utils.getElementById("signup-email");
    this.username = utils.getElementById("signup-name");
    this.password = utils.getElementById("signup-password");
    this.confirmPassword = utils.getElementById("confirm-password");
