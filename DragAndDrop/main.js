class Carousel {
    ...
    #addImages() {
        imageURLs.forEach((imageURL) => 
            this.carouselContainer.appendChild
    ...
    boundCards() {
        ...
        const carouselContainer_rect = this.carouselContainer.getBoundingClientRect();
        if(parseInt(this.carouselContainer.style.left) > 0) {
            ...
            this.carouselContainer.style.left = `-${carouselContainer_rect.width - container_rect.width}px`
        }
    }
}
